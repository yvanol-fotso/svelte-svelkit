...
export const csr = true; //tester a true et false coe c'est un fichier page.ts sa s'execute cote client coe serveru donc il faut faire un inpect source code et activer ou desactiver le line wrap
