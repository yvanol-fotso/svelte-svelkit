...
// Le système essaie automatiquement de savoir s’il peut pré-render la page.

// Si toutes les valeurs possibles de [id] sont connues à l'avance (grâce au paramètre entries ou une API locale connue), alors SvelteKit va générer des pages statiques.

// Sinon, il générera uniquement ce qu’il peut.
