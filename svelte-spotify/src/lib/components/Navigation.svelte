<script lang="ts">
    ...
    import { IconButton, type IconButtonApi } from '$components';
    ...
    let openMenuButton: IconButtonApi | null = null;
    let closeMenuButton: IconButtonApi | null = null;
    let lastFocusableElement: HTMLAnchorElement | null = null;


	// On définit un type pour les composants Svelte instanciables
	...
	// const menuItems: { path: string; label: string; icon: SvelteComponentConstructor  }[] = [
...
<div class="nav-content" class:desktop class:mobile={!desktop}>
    {#if !desktop && isMobileMenuOpen}
        <div
            ...
            on:keypress|preventDefault={handleEscape}
