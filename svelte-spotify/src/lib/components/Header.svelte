<!-- Marche mais pas la search Bar final du proejt ceci se limite a l'avant derneir tutoriele  on va creer un composant les petit bouton qui nou permete de navigeur la  -->
...
<div class="content">
	<div class="left">
	    ...
	    <!-- on fixe notre Header nav -->
		<HeaderNav />

		 <!-- J'ajoute la search Bar  -->
